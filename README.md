...
- **`/walkthrough`** (`skills/walkthrough/`) — Answer a codebase question as an ordered sequence of steps anchored to file locations, with step-by-step navigation in your IDE. [Full skill docs →](skills/walkthrough/SKILL.md)
